...
class PickupMapScreen extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return _PickupMapView(jobId: jobId);
  }
}

class _PickupMapView extends ConsumerStatefulWidget {
  const _PickupMapView({required this.jobId});
  final String jobId;

  @override
  ConsumerState<_PickupMapView> createState() => _PickupMapViewState();
}

class _PickupMapViewState extends ConsumerState<_PickupMapView> {
